        ...
        for seletor_feature in seletor_features:
            ...
            for nome_modelo,parametros in  self.modelos_p_Tete.items():
                ...
                for idx_feature in range(0,len(features)-qtd_it_features-1,qtd_it_features):
                    ...
                    idx_resultado +=1
            resultado.to_csv(f'/content/drive/MyDrive/CEFET/9º Periodo/TCC/testes_outputs/resultados_{nome_modelo}_{seletor_feature}_{metrica_otimizacao}.csv',index=False)
            del resultado 
